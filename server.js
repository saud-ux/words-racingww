...
const ASSISTANT_WORDS = {
  'ا': ['أسد','أرنب','أرض','أمل','أنف','أذن','أرز','إبريق','أثاث','أسرة','أغنية','إبرة','أساس','أوراق','أطفال','إيمان','أفكار','أحلام','أشجار','أنهار','أقلام','إمارة','أسوار','أعمدة','أمير','إعصار','أرجوحة','أفق','أسنان','أكاديمية'],
  'ب': ['بيت','بحر','باب','بنت','بقرة','بلد','برج','بصل','بطيخ','بطة','بومة','بلح','بستان','بلبل','بحيرة','برتقال','بيضة','بئر','بسمة','بخور','بندق','بترول','برميل','بوصلة','بنفسج','بريد','بساط','بركان','بذرة','بطل'],
  'ت': ['تفاح','تمر','تراب','تلميذ','توت','تنين','تاج','ترجمة','تجارة','تعليم','تمساح','تنور','تمثال','تلفاز','تقويم','تحفة','تذكار','تربية','تمارين','تسوق','تنظيم','توابل','تبن','تسامح','تأمل'],
  'ث': ['ثعلب','ثوب','ثلج','ثمار','ثور','ثقافة','ثروة','ثقب','ثريا','ثعبان','ثوم','ثمن','ثابت','ثمانية','ثرثرة'],
  'ج': ['جبل','جمل','جسر','جدار','جنة','جزيرة','جامعة','جرس','جوز','جبن','جندي','جريدة','جمال','جيش','جناح','جليد','جاموس','جوهرة','جراد','جمعة','جيران','جلد','جرة','جزر','جبهة'],
  'ح': ['حصان','حديقة','حوت','حجر','حبل','حقيبة','حليب','حكاية','حرب','حفلة','حلم','حمار','حمامة','حلوى','حضارة','حرير','حكمة','حساب','حبر','حقل','حارة','حظ','حطب','حوض','حنطة'],
  'خ': ['خيل','خبز','خريطة','خيمة','خروف','خشب','خاتم','خزانة','خلية','خضار','خوخ','خيط','خندق','خدمة','خطاب','خزف','خميس','خطوة','خنجر','خلد','خميرة','خابور','خزامى','خفاش','خنفساء'],
  'د': ['دار','دجاجة','دفتر','دلفين','درس','دب','دراجة','دقيق','دواء','دولة','درع','دهان','دموع','دليل','دخان','دنيا','دبوس','دستور','ديك','دائرة','دلو','دمية','درج','دبابة','دعاء'],
  'ذ': ['ذهب','ذئب','ذرة','ذاكرة','ذقن','ذباب','ذيل','ذكاء','ذراع','ذخيرة','ذمة','ذنب','ذوق','ذبابة','ذبح'],
  'ر': ['رمل','رمان','رسالة','ريح','رجل','ركبة','رخام','روضة','رقم','رسم','ربيع','رحلة','رصاص','رعد','رداء','رقبة','رغيف','رفوف','رقعة','رمح','ركيزة','ريشة','رصيف','روح','راية'],
  'ز': ['زهرة','زيت','زرافة','زبدة','زجاج','زيتون','زمرد','زلزال','زنبق','زبيب','زعفران','زنجبيل','زقاق','زفاف','زمزم','زحل','زعتر','زورق','زمام','زمن'],
  'س': ['سمك','سيف','سحاب','سفينة','سلحفاة','سجاد','ساعة','سرير','سلام','سهم','سنجاب','سنبلة','سوق','سور','سراج','سمسم','سلطان','سقف','ساحة','سلسلة','سبورة','سكين','سجن','سراب','سكر'],
  'ش': ['شمس','شجرة','شارع','شتاء','شاي','شمعة','شرطة','شعر','شراع','شاطئ','شطرنج','شبكة','شلال','شهد','شوكة','شعلة','شرفة','شعاع','شريط','شباك','شمال','شحن','شظية','شفق','شراب'],
  'ص': ['صقر','صحراء','صندوق','صابون','صخرة','صاروخ','صدف','صوت','صورة','صلاة','صديق','صباح','صيد','صحيفة','صوف','صنوبر','صدق','صفصاف','صمت','صهريج','صنم','صرح','صفحة','صنارة','صمام'],
  'ض': ['ضوء','ضفدع','ضباب','ضيف','ضمير','ضحك','ضبع','ضفيرة','ضريح','ضجيج','ضرس','ضحى','ضغط','ضمادة','ضفة'],
  'ط': ['طائر','طبيب','طريق','طاولة','طحين','طبل','طائرة','طوب','طفل','طبيعة','طاووس','طقس','طماطم','طبق','طوق','طلاء','طابع','طين','طحلب','طوفان','طنبور','طراز','طرد','طلسم','طنجرة'],
  'ظ': ['ظرف','ظل','ظفر','ظبي','ظهر','ظلام','ظاهرة','ظلم','ظمأ','ظهيرة'],
  'ع': ['عين','عسل','عصفور','عنب','عقرب','علم','عنكبوت','عربة','عجلة','عود','عمود','عاصفة','عقد','عمل','عشب','عطر','عرش','عنق','عجينة','عقاب','عمارة','عروس','عدسة','عيادة','علبة'],
  'غ': ['غابة','غزال','غيمة','غراب','غرفة','غسالة','غطاء','غبار','غصن','غنم','غداء','غلاف','غيث','غناء','غوص','غزل','غرز','غربال','غمد','غرس'],
  'ف': ['فيل','فراشة','فأر','فرن','فجر','فانوس','فستان','فهد','فحم','فاكهة','فضاء','فرس','فارس','فنجان','فلفل','فخار','فلاح','فراء','فرشاة','فسيفساء','فتيل','فولاذ','فندق','فوانيس','فؤاد'],
  'ق': ['قمر','قلم','قطار','قلب','قارب','قصر','قرد','قماش','قفل','قوس','قبعة','قبة','قنديل','قرنفل','قنفذ','قلعة','قصب','قبيلة','قرية','قمح','قوقع','قصيدة','قناة','قمة','قيثارة'],
  'ك': ['كتاب','كلب','كوب','كرسي','كهف','كنز','كعك','كوكب','كمان','كرة','كبريت','كرز','كتف','كمثرى','كركم','كنيسة','كثبان','كابل','كعبة','كحل','كفن','كبد','كبش','كستناء','كمبيوتر'],
  'ل': ['ليل','لعبة','لؤلؤ','ليمون','لوحة','لبن','لهب','لسان','لحم','لباس','لغز','لوز','لبان','لافتة','لمبة','لطف','لقلق','لجام','لهجة','لثة','لحاف','لوبياء','لقاح','لبلاب','لباد'],
  'م': ['مدرسة','ماء','مفتاح','مسجد','ملعب','مطبخ','مزرعة','مائدة','ميناء','منارة','مرآة','مظلة','محيط','معبد','مهندس','مغارة','منجم','مركب','مصباح','مكتبة','موسيقى','ملابس','مرجان','مدينة','منديل'],
  'ن': ['نجم','نهر','نار','نخلة','نحلة','نسر','نافذة','نمر','ناقة','نعل','نسيم','نبع','نعناع','نرجس','نقود','نعامة','نبات','نحاس','نخيل','نعمة','نيزك','نافورة','نشيد','نمل','نور'],
  'ه': ['هلال','هرم','هاتف','هدية','هواء','هيكل','هندسة','همس','هضبة','هدهد','هجرة','همة','هدف','هيبة','هامش','هيل','هالة','هاون','هزار','هجين'],
  'و': ['وردة','وطن','وسادة','وعل','وقود','وحش','وادي','ورشة','وثيقة','وهج','وجبة','ورقة','وعاء','وفاء','وفد','وشاح','وصفة','وزير','ولد','وبر'],
  'ي': ['يد','ياسمين','يقطين','يمامة','ينبوع','يراع','يخت','ياقوت','يوسفي','يرقة','يانسون','يابسة','يعسوب','يقظة','يمين'],
};
