...
const ASSISTANT_WORDS = {
  ...
  'ذ': ['ذيب','ذهب','ذرة','ذيل','ذقن','ذباب','ذراع','ذوق','ذكي','ذاكرة','ذبيان','ذهبي','ذبذبة','ذخيرة','ذنب'],
  ...
  'ش': ['شمس','شتا','شاي','شاورما','شوربة','شمعة','شجرة','شارع','شرطة','شعر','شراع','شطرنج','شبكة','شلال','شهد','شوكة','شرفة','شريط','شباك','شمال','شراب','شيخ','شريان','شفق','شكشوكة'],
  ...
  'ك': ['كبسة','كنافة','كشري','كوب','كرسي','كلب','كتاب','كهف','كنز','كعك','كوكب','كمان','كرة','كرز','كركم','كبش','كحل','كبد','كمبيوتر','كاميرا','كوريا','كندا','كويت','كاكاو','كابل'],
